...
@ConfigSerializable
data class OrbitingSpaceObjectImplementation(
	...
	override val offsetZ: Int = 0,

	override val orbitWidth: Int = 1000,
	override val orbitHeight: Int = 1000,

	override val orbitRotation: Int = 0,
...
) : AbstractSpaceObject(), OrbitingSpaceObject